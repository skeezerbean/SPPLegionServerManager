...
namespace SPPLegionServerManager.Models
{
	/// <summary>
	...
	public static class GeneralSettingsManager
	{
		...
		{
			try { File.WriteAllText(path, JsonConvert.SerializeObject(item, Newtonsoft.Json.Formatting.Indented)); }
			catch { return false; }
			return true;
		}
	...
	{
		public string RepackPath { get; set; } = "C:\\";
